...
let mongoUrlLocal = "mongodb://admin:password@localhost:27017/audio-db?authSource=admin&readPreference=primary&ssl=false&directConnection=true";
...
const conn = mongoose.createConnection(mongoUrlDocker);
conn.once('open', () => {
  // Init stream
...
mongoose.connect(mongoUrlDocker).then(res=>{
